...
<?php
	...
	public function get_mepr_transaction_by_subscription_id($subscription_id)

	{

		global $wpdb;

		return $wpdb->get_results("SELECT * FROM  {$wpdb->prefix}mepr_transactions WHERE subscription_id = '{$subscription_id}'");
	}
}
